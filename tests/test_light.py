...
def _make_light(
    ...
    entity = TcIotLight(coordinator, MOCK_DEVICE_NAME, widget)
    attach_entity_to_hass(hass, entity, "light")
...
class TestRGBWWidget:
    ...
    def test_color_modes_hs_only(self, hass, mock_config_entry) -> None:
        ...
        entity, _ = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-hs-only.json")
    ...
    def test_turn_on_hs(self, hass, mock_config_entry) -> None:
        entity, coord = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-hs-only.json")
        entity.widget.values[VAL_LIGHT_ON] = True
        hass.loop.run_until_complete(
    ...
    def test_no_rgbw_color(self, hass, mock_config_entry) -> None:
        """Non-EL2564 with no white slider should never expose rgbw_color."""
        entity, _ = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-hs-only.json")
...
class TestRGBWWithWhite:
    ...
    def test_color_modes_rgbw(self, hass, mock_config_entry) -> None:
        ...
        entity, _ = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-white-and-ct-sliders.json")
    ...
    def test_turn_on_rgbw(self, hass, mock_config_entry) -> None:
        ...
        entity, coord = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-white-and-ct-sliders.json")
        hass.loop.run_until_complete(
    ...
    def test_state_write_only_on_mode_change(self, hass, mock_config_entry) -> None:
        """Optimistic updates invoke async_write_ha_state when entity is bound to hass."""
        entity, _ = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-white-and-ct-sliders.json")
...
class TestRGBWFuture:
    ...
    def test_color_mode_hs(self, hass, mock_config_entry) -> None:
        ...
        entity, _ = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-future-rgb-palette.json")
        assert ColorMode.HS in entity.supported_color_modes
    ...
    def test_turn_on_no_color_mode_written(self, hass, mock_config_entry) -> None:
        ...
        entity, coord = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-future-rgb-palette.json")
        hass.loop.run_until_complete(entity.async_turn_on())
        cmd = coord.async_send_command.call_args[0][1]
        path = entity.widget.path
    ...
    def test_non_numeric_color_mode_falls_back(self, hass, mock_config_entry) -> None:
        """Non-numeric nColorMode from PLC falls back to a default, not crash."""
        entity, _ = _make_light(hass, mock_config_entry, "widgets/variants/widget-rgbw-future-rgb-palette.json")
...
class TestLightModeHidden:
    ...
    def test_effect_list_empty(self, hass, mock_config_entry) -> None:
        ...
        entity, _ = _make_light(
            hass, mock_config_entry, "widgets/variants/widget-lighting-mode-hidden.json",
        )
